...
.method public static z(Lj$/time/chrono/Chronology;Lj$/time/temporal/Temporal;)Lj$/time/chrono/ChronoLocalDate;
    .locals 1
...
# virtual methods
.method public final A(Lj$/time/chrono/ChronoLocalDate;)J
    .locals 8
    ...
    .line 20
    .line 21
    invoke-interface {p0, v0}, Lj$/time/temporal/TemporalAccessor;->s(Lj$/time/temporal/TemporalField;)J
    ...
    .line 41
    invoke-interface {p1, v5}, Lj$/time/temporal/TemporalAccessor;->e(Lj$/time/temporal/TemporalField;)I
...
.method public abstract B(J)Lj$/time/chrono/ChronoLocalDate;
.end method

.method public abstract C(J)Lj$/time/chrono/ChronoLocalDate;
.end method
...
.method public a(JLj$/time/temporal/TemporalField;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 13
    invoke-static {v0, p0}, Lj$/time/chrono/c;->z(Lj$/time/chrono/Chronology;Lj$/time/temporal/Temporal;)Lj$/time/chrono/ChronoLocalDate;
...
.method public b(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 27
    .line 28
    invoke-interface {p0, p3}, Lj$/time/temporal/TemporalAccessor;->s(Lj$/time/temporal/TemporalField;)J
    ...
    .line 47
    invoke-virtual {p0, p1, p2}, Lj$/time/chrono/c;->D(J)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 79
    :pswitch_5
    invoke-virtual {p0, p1, p2}, Lj$/time/chrono/c;->C(J)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 90
    invoke-virtual {p0, p1, p2}, Lj$/time/chrono/c;->B(J)Lj$/time/chrono/ChronoLocalDate;
...
.method public bridge synthetic f(Lj$/time/LocalDate;)Lj$/time/temporal/Temporal;
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Lj$/time/chrono/c;->o(Lj$/time/temporal/k;)Lj$/time/chrono/ChronoLocalDate;
...
.method public synthetic g(Lj$/time/temporal/TemporalField;)Lj$/time/temporal/p;
    .locals 0
...
.method public getEra()Lj$/time/chrono/j;
    .locals 2
    ...
    .line 11
    invoke-interface {v0, p0}, Lj$/time/chrono/Chronology;->eraOf(I)Lj$/time/chrono/j;
...
.method public final synthetic i(Lj$/time/temporal/Temporal;)Lj$/time/temporal/Temporal;
    .locals 0
...
.method public isLeapYear()Z
    ...
    .line 6
    .line 7
    invoke-interface {p0, v1}, Lj$/time/temporal/TemporalAccessor;->s(Lj$/time/temporal/TemporalField;)J
...
.method public k(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/ChronoLocalDate;
    .locals 1
...
.method public o(Lj$/time/temporal/k;)Lj$/time/chrono/ChronoLocalDate;
    .locals 1
...
.method public bridge synthetic p(JLj$/time/temporal/ChronoUnit;)Lj$/time/temporal/Temporal;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/c;->k(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/ChronoLocalDate;
...
.method public t(Lj$/time/LocalTime;)Lj$/time/chrono/ChronoLocalDateTime;
    .locals 1
...
.method public final toString()Ljava/lang/String;
    ...
    .line 14
    .line 15
    invoke-interface {p0, v4}, Lj$/time/temporal/TemporalAccessor;->s(Lj$/time/temporal/TemporalField;)J
    ...
    .line 41
    .line 42
    invoke-virtual {p0}, Lj$/time/chrono/c;->getEra()Lj$/time/chrono/j;
...
.method public final until(Lj$/time/temporal/Temporal;Lj$/time/temporal/TemporalUnit;)J
    ...
    .line 41
    .line 42
    invoke-interface {p1, p2}, Lj$/time/temporal/TemporalAccessor;->s(Lj$/time/temporal/TemporalField;)J
    ...
    .line 46
    invoke-interface {p0, p2}, Lj$/time/temporal/TemporalAccessor;->s(Lj$/time/temporal/TemporalField;)J
    ...
    .line 52
    :pswitch_1
    invoke-virtual {p0, p1}, Lj$/time/chrono/c;->A(Lj$/time/chrono/ChronoLocalDate;)J
...
.method public w(Lj$/time/temporal/m;)Lj$/time/chrono/ChronoLocalDate;
    .locals 1
