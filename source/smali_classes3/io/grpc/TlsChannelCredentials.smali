...
.method public constructor <init>(Lio/grpc/TlsChannelCredentials$Builder;)V
    ...
    .line 3
    .line 4
    invoke-static {p1}, Lio/grpc/TlsChannelCredentials$Builder;->b(Lio/grpc/TlsChannelCredentials$Builder;)Z
    ...
    .line 9
    .line 10
    invoke-static {p1}, Lio/grpc/TlsChannelCredentials$Builder;->a(Lio/grpc/TlsChannelCredentials$Builder;)[B
    ...
    .line 15
    .line 16
    invoke-static {p1}, Lio/grpc/TlsChannelCredentials$Builder;->d(Lio/grpc/TlsChannelCredentials$Builder;)[B
    ...
    .line 21
    .line 22
    invoke-static {p1}, Lio/grpc/TlsChannelCredentials$Builder;->e(Lio/grpc/TlsChannelCredentials$Builder;)Ljava/lang/String;
    ...
    .line 27
    .line 28
    invoke-static {p1}, Lio/grpc/TlsChannelCredentials$Builder;->c(Lio/grpc/TlsChannelCredentials$Builder;)Ljava/util/List;
    ...
    .line 33
    .line 34
    invoke-static {p1}, Lio/grpc/TlsChannelCredentials$Builder;->f(Lio/grpc/TlsChannelCredentials$Builder;)[B
    ...
    .line 39
    .line 40
    invoke-static {p1}, Lio/grpc/TlsChannelCredentials$Builder;->g(Lio/grpc/TlsChannelCredentials$Builder;)Ljava/util/List;
...
.method public static newBuilder()Lio/grpc/TlsChannelCredentials$Builder;
    ...
    .line 4
    invoke-direct {v0, v1}, Lio/grpc/TlsChannelCredentials$Builder;-><init>(I)V
...
.method public getCertificateChain()[B
    ...
    .line 1
    iget-object p0, p0, Lio/grpc/TlsChannelCredentials;->certificateChain:[B
...
.method public getKeyManagers()Ljava/util/List;
    ...
    .line 1
    iget-object p0, p0, Lio/grpc/TlsChannelCredentials;->keyManagers:Ljava/util/List;
...
.method public getPrivateKey()[B
    ...
    .line 1
    iget-object p0, p0, Lio/grpc/TlsChannelCredentials;->privateKey:[B
...
.method public getPrivateKeyPassword()Ljava/lang/String;
    ...
    .line 1
    iget-object p0, p0, Lio/grpc/TlsChannelCredentials;->privateKeyPassword:Ljava/lang/String;
...
.method public getRootCertificates()[B
    ...
    .line 1
    iget-object p0, p0, Lio/grpc/TlsChannelCredentials;->rootCertificates:[B
...
.method public getTrustManagers()Ljava/util/List;
    ...
    .line 1
    iget-object p0, p0, Lio/grpc/TlsChannelCredentials;->trustManagers:Ljava/util/List;
...
.method public incomprehensible(Ljava/util/Set;)Ljava/util/Set;
    ...
    .line 41
    :cond_3
    sget-object p0, Lio/grpc/TlsChannelCredentials$Feature;->CUSTOM_MANAGERS:Lio/grpc/TlsChannelCredentials$Feature;

    .line 42
    .line 43
    invoke-static {p1, v0, p0}, Lio/grpc/TlsChannelCredentials;->requiredFeature(Ljava/util/Set;Ljava/util/Set;Lio/grpc/TlsChannelCredentials$Feature;)V
