...
.method public static declared-synchronized getDefaultRegistry()Lio/grpc/ServerRegistry;
    ...
    .line 23
    invoke-direct {v4, v5}, Lio/grpc/ServerRegistry$ServerPriorityAccessor;-><init>(I)V
...
.method public newServerBuilderForPort(ILio/grpc/ServerCredentials;)Lio/grpc/ServerBuilder;
    ...
    .line 35
    .line 36
    invoke-virtual {v1, p1, p2}, Lio/grpc/ServerProvider;->newServerBuilderForPort(ILio/grpc/ServerCredentials;)Lio/grpc/ServerProvider$NewServerBuilderResult;
    ...
    .line 40
    invoke-virtual {v2}, Lio/grpc/ServerProvider$NewServerBuilderResult;->getServerBuilder()Lio/grpc/ServerBuilder;
    ...
    .line 71
    .line 72
    invoke-virtual {v2}, Lio/grpc/ServerProvider$NewServerBuilderResult;->getError()Ljava/lang/String;
    ...
    .line 80
    :cond_1
    new-instance p0, Lio/grpc/ServerRegistry$ProviderNotFoundException;
    ...
    .line 87
    invoke-direct {p0, p1}, Lio/grpc/ServerRegistry$ProviderNotFoundException;-><init>(Ljava/lang/String;)V
    ...
    .line 92
    .line 93
    const-string p1, "No functional server found. Try adding a dependency on the grpc-netty, grpc-netty-shaded, or grpc-okhttp artifact"
...
.method public provider()Lio/grpc/ServerProvider;
    ...
    .line 18
    check-cast p0, Lio/grpc/ServerProvider;
