.class final Lio/grpc/util/OutlierDetectionLoadBalancer$OutlierDetectionSubchannel;
...
.field private endpointTracker:Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;
...
.method public static bridge synthetic a(Lio/grpc/util/OutlierDetectionLoadBalancer$OutlierDetectionSubchannel;)Z
    .locals 0
...
.method public static bridge synthetic b(Lio/grpc/util/OutlierDetectionLoadBalancer$OutlierDetectionSubchannel;Lio/grpc/ConnectivityStateInfo;)V
    .locals 0
...
# virtual methods
.method public clearEndpointTracker()V
    .locals 1
    ...
    .line 2
    iput-object v0, p0, Lio/grpc/util/OutlierDetectionLoadBalancer$OutlierDetectionSubchannel;->endpointTracker:Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;
...
.method public eject()V
    ...
    .line 29
    .line 30
    const-string p0, "Subchannel ejected: {0}"

    .line 31
    .line 32
    invoke-virtual {v1, v2, p0, v0}, Lio/grpc/ChannelLogger;->log(Lio/grpc/ChannelLogger$ChannelLogLevel;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public getAttributes()Lio/grpc/Attributes;
    ...
    .line 1
    iget-object v0, p0, Lio/grpc/util/OutlierDetectionLoadBalancer$OutlierDetectionSubchannel;->endpointTracker:Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;
    ...
    .line 15
    invoke-static {}, Lio/grpc/util/OutlierDetectionLoadBalancer;->d()Lio/grpc/Attributes$Key;
    ...
    .line 19
    iget-object p0, p0, Lio/grpc/util/OutlierDetectionLoadBalancer$OutlierDetectionSubchannel;->endpointTracker:Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;
...
.method public setEndpointTracker(Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lio/grpc/util/OutlierDetectionLoadBalancer$OutlierDetectionSubchannel;->endpointTracker:Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;
...
.method public shutdown()V
    ...
    .line 4
    .line 5
    invoke-virtual {v0, p0}, Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;->removeSubchannel(Lio/grpc/util/OutlierDetectionLoadBalancer$OutlierDetectionSubchannel;)Z
...
.method public uneject()V
    ...
    .line 21
    .line 22
    const-string p0, "Subchannel unejected: {0}"

    .line 23
    .line 24
    invoke-virtual {v1, v2, p0, v3}, Lio/grpc/ChannelLogger;->log(Lio/grpc/ChannelLogger$ChannelLogLevel;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public updateAddresses(Ljava/util/List;)V
    ...
    .line 5
    invoke-static {v0}, Lio/grpc/util/OutlierDetectionLoadBalancer;->e(Ljava/util/List;)Z
    ...
    .line 11
    .line 12
    invoke-static {p1}, Lio/grpc/util/OutlierDetectionLoadBalancer;->e(Ljava/util/List;)Z
    ...
    .line 21
    .line 22
    iget-object v2, p0, Lio/grpc/util/OutlierDetectionLoadBalancer$OutlierDetectionSubchannel;->endpointTracker:Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;

    .line 23
    .line 24
    invoke-virtual {v0, v2}, Lzl5;->containsValue(Ljava/lang/Object;)Z
    ...
    .line 52
    .line 53
    iget-object v1, v1, Lio/grpc/util/OutlierDetectionLoadBalancer;->addressMap:Ljava/util/Map;
    ...
    .line 69
    check-cast v0, Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;

    .line 70
    .line 71
    invoke-virtual {v0, p0}, Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;->addSubchannel(Lio/grpc/util/OutlierDetectionLoadBalancer$OutlierDetectionSubchannel;)Z
    ...
    .line 93
    .line 94
    iget-object v0, v0, Lio/grpc/util/OutlierDetectionLoadBalancer;->addressMap:Ljava/util/Map;
    ...
    .line 138
    .line 139
    invoke-virtual {v0}, Lio/grpc/util/OutlierDetectionLoadBalancer$EndpointTracker;->resetCallCounters()V
