...
.field private failureCause:Lio/grpc/Status;
...
.method public constructor <init>(JLdxd;)V
    .locals 1
    ...
    .line 12
    .line 13
    iput-object p3, p0, Lio/grpc/internal/Http2Ping;->stopwatch:Ldxd;
...
.method private static asRunnable(Lio/grpc/internal/ClientTransport$PingCallback;Lio/grpc/Status;)Ljava/lang/Runnable;
    .locals 1

    .line 7
    new-instance v0, Lio/grpc/internal/Http2Ping$2;

    invoke-direct {v0, p0, p1}, Lio/grpc/internal/Http2Ping$2;-><init>(Lio/grpc/internal/ClientTransport$PingCallback;Lio/grpc/Status;)V
...
.method public static notifyFailed(Lio/grpc/internal/ClientTransport$PingCallback;Ljava/util/concurrent/Executor;Lio/grpc/Status;)V
    .locals 0

    .line 1
    invoke-static {p0, p2}, Lio/grpc/internal/Http2Ping;->asRunnable(Lio/grpc/internal/ClientTransport$PingCallback;Lio/grpc/Status;)Ljava/lang/Runnable;
...
.method public addCallback(Lio/grpc/internal/ClientTransport$PingCallback;Ljava/util/concurrent/Executor;)V
    ...
    .line 15
    :cond_0
    iget-object v0, p0, Lio/grpc/internal/Http2Ping;->failureCause:Lio/grpc/Status;
    ...
    .line 18
    .line 19
    invoke-static {p1, v0}, Lio/grpc/internal/Http2Ping;->asRunnable(Lio/grpc/internal/ClientTransport$PingCallback;Lio/grpc/Status;)Ljava/lang/Runnable;
...
.method public complete()Z
    ...
    .line 13
    .line 14
    iget-object v1, p0, Lio/grpc/internal/Http2Ping;->stopwatch:Ldxd;
    ...
    .line 17
    .line 18
    invoke-virtual {v1, v2}, Ldxd;->a(Ljava/util/concurrent/TimeUnit;)J
...
.method public failed(Lio/grpc/Status;)V
    .locals 2
    ...
    .line 12
    .line 13
    iput-object p1, p0, Lio/grpc/internal/Http2Ping;->failureCause:Lio/grpc/Status;
    ...
    .line 52
    .line 53
    invoke-static {v1, v0, p1}, Lio/grpc/internal/Http2Ping;->notifyFailed(Lio/grpc/internal/ClientTransport$PingCallback;Ljava/util/concurrent/Executor;Lio/grpc/Status;)V
